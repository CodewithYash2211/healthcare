...
export const translations: Translations = {
  ...
  heartRate: { en: 'Heart Rate', hi: 'दिल की धड़कन', mr: 'हृदयाचे ठोके' },
  oxygenLevel: { en: 'Oxygen Level', hi: 'ऑक्सीजन का स्तर', mr: 'ऑक्सिजनची पातळी' },
  ...
  continueWithGoogle: { en: 'Continue with Google', hi: 'गूगल के साथ जारी रखें', mr: 'गूगलसह सुरू ठेवा' },
  loginWithPhone: { en: 'Login with Mobile Number', hi: 'मोबाइल नंबर के साथ लॉगिन करें', mr: 'मोबाईल नंबरसह लॉगिन करा' },
  phoneNumber: { en: 'Phone Number', hi: 'फ़ोन नंबर', mr: 'फोन नंबर' },
  sendOtp: { en: 'Send OTP', hi: 'ओटीपी भेजें', mr: 'ओटीपी पाठवा' },
  verifyPhone: { en: 'Verify Phone', hi: 'फ़ोन सत्यापित करें', mr: 'फोन सत्यापित करा' },
  otpSentTo: { en: 'OTP sent to', hi: 'ओटीपी भेजा गया', mr: 'ओटीपी पाठविला' },
  enterOtp: { en: 'Enter 6-digit OTP', hi: '6-अंकीय ओटीपी दर्ज करें', mr: '6-अंकी ओटीपी प्रविष्ट करा' },
  verifyAndLogin: { en: 'Verify and Login', hi: 'सत्यापित करें और लॉगिन करें', mr: 'सत्यापित करा आणि लॉगिन करा' },
  verifying: { en: 'Verifying...', hi: 'सत्यापित किया जा रहा है...', mr: 'सत्यापित करत आहे...' },
  didntReceiveCode: { en: "Didn't receive code?", hi: 'कोड नहीं मिला?', mr: 'कोड मिळाला नाही?' },
  resendCode: { en: 'Resend Code', hi: 'कोड फिर से भेजें', mr: 'कोड पुन्हा पाठवा' },
  backToLogin: { en: 'Back to Login', hi: 'लॉगिन पर वापस जाएं', mr: 'लॉगिनवर परत जा' },
  voiceConsultation: { en: 'Voice Consultation', hi: 'आवाज परामर्श', mr: 'व्हॉइस सल्लामसलत' },
  videoConsultation: { en: 'Video Consultation', hi: 'वीडियो परामर्श', mr: 'व्हिडिओ सल्लामसलत' },
  startVideo: { en: 'Start Video Call', hi: 'वीडियो कॉल शुरू करें', mr: 'व्हिडिओ कॉल सुरू करा' },
  startVoice: { en: 'Start Voice Call', hi: 'आवाज कॉल शुरू करें', mr: 'व्हॉइस कॉल सुरू करा' },
  endSession: { en: 'End Session', hi: 'सत्र समाप्त करें', mr: 'सत्र समाप्त करा' },
  mute: { en: 'Mute', hi: 'म्यूट', mr: 'म्यूट' },
  unmute: { en: 'Unmute', hi: 'अनम्यूट', mr: 'अनम्यूट' },
  cameraOn: { en: 'Camera On', hi: 'कैमरा चालू', mr: 'कॅमेरा चालू' },
  cameraOff: { en: 'Camera Off', hi: 'कैमरा बंद', mr: 'कॅमेरा बंद' },
  connecting: { en: 'Connecting...', hi: 'कनेक्ट किया जा रहा है...', mr: 'कनेक्ट करत आहे...' },
  sessionActive: { en: 'Session Active', hi: 'सत्र सक्रिय', mr: 'सत्र सक्रिय' },
  callEnded: { en: 'Call Ended', hi: 'कॉल समाप्त', mr: 'कॉल संपला' },
  waitingForDoctor: { en: 'Waiting for Doctor to join...', hi: 'डॉक्टर के जुड़ने की प्रतीक्षा की जा रही है...', mr: 'डॉक्टर सामील होण्याची प्रतीक्षा करत आहे...' },
  waitingForWorker: { en: 'Waiting for Health Worker...', hi: 'स्वास्थ्य कार्यकर्ता की प्रतीक्षा की जा रही है...', mr: 'आरोग्य कार्यकर्त्याची प्रतीक्षा करत आहे...' },
  permissionsRequired: { en: 'Camera & Microphone permissions required', hi: 'कैमरा और माइक्रोफोन अनुमति आवश्यक है', mr: 'कॅमेरा आणि मायक्रोफोन परवानग्या आवश्यक आहेत' },
  voice: { en: 'Voice', hi: 'आवाज', mr: 'आवाज' },
