...
export const translations: Translations = {
  appName: { en: 'SehatSetu', hi: 'सेहतसेतु', mr: 'सेहतसेतू' },
  ...
  highRiskPatients: { en: 'High Risk Patients', hi: 'उच्च जोखिम वाले मरीज', mr: 'उच्च जोखीम असलेले रुग्ण' },
  healthScreeningsToday: { en: 'Health Screenings Today', hi: 'आज की स्वास्थ्य जांच', mr: 'आजची आरोग्य तपासणी' },
  pendingCasesCount: { en: 'Pending Cases', hi: 'लंबित मामले', mr: 'प्रलंबित प्रकरणे' },
  registerNewPatient: { en: 'Register New Patient', hi: 'नया मरीज पंजीकृत करें', mr: 'नवीन रुग्णाची नोंदणी करा' },
  startHealthScreening: { en: 'Start Health Screening', hi: 'स्वास्थ्य जांच शुरू करें', mr: 'आरोग्य तपासणी सुरू करा' },
  referToHospital: { en: 'Refer to Hospital', hi: 'अस्पताल रेफर करें', mr: 'रुग्णालयात संदर्भित करा' },
  recentPatients: { en: 'Recent Patients', hi: 'हाल के मरीज', mr: 'अलीकडील रुग्ण' },
  healthScreeningReports: { en: 'Health Screening Reports', hi: 'स्वास्थ्य जांच रिपोर्ट', mr: 'आरोग्य तपासणी अहवाल' },
  viewFullAnalysis: { en: 'View Full Report', hi: 'पूरी रिपोर्ट देखें', mr: 'पूर्ण अहवाल पहा' },
  noPatientsRegistered: { en: 'No patients registered yet', hi: 'अभी तक कोई मरीज पंजीकृत नहीं है', mr: 'अद्याप कोणत्याही रुग्णाची नोंदणी झालेली नाही' },
  noScreeningsPerformed: { en: 'No health screenings performed yet', hi: 'अभी तक कोई स्वास्थ्य जांच नहीं की गई है', mr: 'अद्याप कोणतीही आरोग्य तपासणी केलेली नाही' },
  patientsToday: { en: 'Patients Today', hi: 'आज के मरीज', mr: 'आजचे रुग्ण' },
  pendingConsultations: { en: 'Pending Consultations', hi: 'लंबित परामर्श', mr: 'प्रलंबित सल्लामसलत' },
  reportsGenerated: { en: 'Reports Generated', hi: 'रिपोर्ट जेनरेट की गई', mr: 'अहवाल जनरेट केले' },
  criticalCases: { en: 'Critical Cases', hi: 'गंभीर मामले', mr: 'गंभीर प्रकरणे' },
  patientQueue: { en: 'Patient Queue', hi: 'मरीज की कतार', mr: 'रुग्ण रांग' },
  healthSummaries: { en: 'Health Summaries', hi: 'स्वास्थ्य सारांश', mr: 'आरोग्य सारांश' },
  highPriorityAlerts: { en: 'High Priority Alerts', hi: 'उच्च प्राथमिकता अलर्ट', mr: 'उच्च प्राथमिकता अलर्ट' },
  casesRequireAttention: { en: '{count} cases require immediate attention.', hi: '{count} मामलों पर तत्काल ध्यान देने की आवश्यकता है।', mr: '{count} प्रकरणांकडे तातडीने लक्ष देणे आवश्यक आहे.' },
  noCriticalAlerts: { en: 'No critical alerts presently.', hi: 'वर्तमान में कोई गंभीर अलर्ट नहीं है।', mr: 'सध्या कोणतेही गंभीर अलर्ट नाहीत.' },
  quickConsultation: { en: 'Quick Consultation', hi: 'त्वरित परामर्श', mr: 'त्वरित सल्लामसलत' },
  startQueueSession: { en: 'Start reviewing the pending queue automatically. SehatSetu will present cases one by one.', hi: 'लंबित कतार की स्वचालित रूप से समीक्षा करना शुरू करें। SehatSetu एक-एक करके मामले पेश करेगा।', mr: 'प्रलंबित रांगेचे स्वयंचलितपणे पुनरावलोकन करणे सुरू करा. SehatSetu एक-एक करून प्रकरणे सादर करेल.' },
  beginSession: { en: 'Begin Session', hi: 'सत्र शुरू करें', mr: 'सत्र सुरू करा' },
  startQueue: { en: 'Start Queue', hi: 'कतार शुरू करें', mr: 'रांग सुरू करा' },
  allCaughtUp: { en: 'All caught up!', hi: 'सब हो गया!', mr: 'सर्व पूर्ण झाले!' },
  hospitals: { en: 'Hospitals', hi: 'अस्पताल', mr: 'रुग्णालये' },
  mapView: { en: 'Map View', hi: 'नक्शा दृश्य', mr: 'नकाशा दृश्य' },
  settings: { en: 'Settings', hi: 'सेटिंग्स', mr: 'सेटिंग्ज' },
  reports: { en: 'Reports', hi: 'रिपोर्ट', mr: 'अहवाल' },
  searchBarPlaceholder: { en: 'Search patients, doctors, or reports...', hi: 'मरीज़ों, डॉक्टरों या रिपोर्टों को खोजें...', mr: 'रुग्ण, डॉक्टर किंवा अहवाल शोधा...' },
  clickToLogout: { en: 'Click to logout', hi: 'लॉगआउट करने के लिए क्लिक करें', mr: 'लॉगआउट करण्यासाठी क्लिक करा' },
};
